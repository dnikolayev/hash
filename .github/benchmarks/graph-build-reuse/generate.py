...
'''
    ...
    save_if = "env.HASH_GRAPH_BUILD_CACHE == '1' && steps.graph-cache.outputs.cache-hit != 'true' && steps.graph-upload.outputs.valid == 'true'"
    if variant == 'baseline':
        # Preserve the completed baseline bytes; cache mode 0 skips both steps.
